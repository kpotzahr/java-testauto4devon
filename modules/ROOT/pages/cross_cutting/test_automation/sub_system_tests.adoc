...
Similar to the motivation for the page object pattern, you don't want to change all tests or all page objects, if the internal structure of such a compoenent changes. 
